...
export default {
    methods: {
        ...
        imprimir : function (pessoa, callback){
            var self = this;
            if (qz.websocket.isActive())
                qz.websocket.disconnect();
            
            qz.websocket.connect().then(function() { 
                return qz.printers.find("argox")               // Pass the printer name into the next Promise
            }).then(function(printer) {
                var pessoa = {
                    id: 'etiqueta',
                    event: 'Congresso de Famílias 2018',
                    nickname: self.inscricao.pessoa.nomecracha,
                    fullname: self.inscricao.pessoa.nome,
                    city: self.inscricao.pessoa.cidade,
                    eatPlace: 'L',
                    eatGroup: 'A'
                };
